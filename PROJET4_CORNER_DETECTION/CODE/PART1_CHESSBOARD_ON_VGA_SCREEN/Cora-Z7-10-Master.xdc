...
# RGB LEDs
#set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports out_LED0_B]
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports out_LED0_G]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports out_LED0_R]
##set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports out_LED1_B]
##set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports out_LED1_G]
#set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports out_LED1_R]
...
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {out_filt_G[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {out_filt_G[3]}]
