...
# RGB LEDs
set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports out_LED_B]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports out_LED_G]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports out_LED_R]
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports end_counter_cycle]
...
# Buttons
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports bouton_0]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports bouton_1]

## Pmod Header JA
#set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports resetn]
...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { resetn }]; #IO_L8P_T1_34 Sch=jb_p[1]
